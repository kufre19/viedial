                        ...
                        <form method="POST" action="{{  route('password.update') }}">
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="email" name="email" class="form-control pl-15 bg-transparent @error('email') is-invalid @enderror" placeholder="Email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                                    @error('email')
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password"  class="form-control pl-15 bg-transparent @error('password_confirmation') is-invalid @enderror" placeholder="Confirm Password" name="password_confirmation" required autocomplete="new-password">
