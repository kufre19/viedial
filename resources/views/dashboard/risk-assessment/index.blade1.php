...
<head>
	...
	<!-- Font-->
	<link rel="stylesheet" type="text/css" href="{{asset('view_assets/risk_assessment/css/roboto-font.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('view_assets/risk_assessment/fonts/material-design-iconic-font/css/material-design-iconic-font.min.css')}}">
	<!-- datepicker -->
	<link rel="stylesheet" type="text/css" href="{{asset('view_assets/risk_assessment/css/jquery-ui.min.css')}}">
	<!-- Main Style Css -->
...
<body>
	<div class="page-content" style="background-image: linear-gradient(to right, #800020, #c24262);">
		<div class="wizard-v3-content">
			<div class="wizard-form">
				<div class="wizard-header">
					<h3 class="heading">Risk Assessment</h3>
					<p>Answer the followng Questions to know Your Risk</p>
				</div>
	...
	<script src="{{asset('view_assets/risk_assessment/js/jquery-ui.min.js')}}"></script>
