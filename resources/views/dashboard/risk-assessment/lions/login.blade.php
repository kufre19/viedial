            ...
            <div class="col-lg-5 col-md-5 col-12">
                <div class="bg-white rounded30 shadow-lg">
                    <div class="content-top-agile p-20 pb-0">
                        <img src="{{asset('view_assets/lions_asset/lions-logo-2.jpeg')}}" width="20%" height="20%" alt="">

                        <h2 class="text-viedial">Viedial Health</h2>
                    ...
                    <div class="p-40">
                        <form action="{{url('lions-club/login')}}" method="post">
                            @csrf
