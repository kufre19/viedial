                ...
                <div class="box-body bg-img" style="background-image: url({{ asset('view_assets/images/bg-5.png') }});"
                    ...
                    <div class="d-lg-flex align-items-center justify-content-between">
                        <div class="d-md-flex align-items-center mb-30 mb-lg-0 w-p100">
                            <img src="{{ asset('view_assets/images/bmi-icon.svg') }}" class="img-fluid max-w-150"
                                alt="" />
                            <div class="ml-30">
                        ...
                        <div>
                            <a href="{{ url('set-your-goals') }}"
                                class="waves-effect waves-light btn-block btn btn-dark" style="white-space: nowrap;">Set
                                Goal
                                Now!</a>
                        </div>
                    </div>
